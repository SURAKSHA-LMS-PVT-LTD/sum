...
import { Wifi, ArrowLeft, CalendarClock, MapPin, CheckCircle, User, Loader2, Building2, GraduationCap, BookOpen, AlertCircle, Nfc } from 'lucide-react';
          ...
          <CardContent className="p-0">
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-6 lg:p-8 flex flex-col justify-center space-y-5">
                {/* NFC Button — prominent on mobile, shown when supported or on any mobile device */}
