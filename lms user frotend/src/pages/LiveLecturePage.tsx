              ...
              <div className="flex flex-col items-center justify-center h-full text-center gap-5">
                ...
                {info?.meetingLink && (
                  <a href={info.meetingLink} target="_blank" rel="noreferrer"
                    className="inline-flex items-center gap-2.5 px-8 py-3.5 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold text-sm hover:from-blue-700 hover:to-blue-800 transition shadow-lg shadow-blue-500/25">
