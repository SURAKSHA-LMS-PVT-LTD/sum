...
const FEATURES: FeatureRow[] = [
  ...
  { key: 'class-subjects',              label: 'Subjects',                 description: 'Subjects assigned to this class',                     scope: 'CLASS',     category: 'ACADEMICS',      pricing: 'FREE',  billing_cycle: 'MONTHLY', is_core: true,  dependencies: [],                        ui_targets: ['sidebar', 'dashboard'], is_active: true },
  ...
  { key: 'class-payments',             label: 'Class Payments',           description: 'Manage class-level fee collection',                   scope: 'CLASS',     category: 'PAYMENTS',       pricing: 'FREE',  billing_cycle: 'MONTHLY', is_core: false, dependencies: [],                        ui_targets: ['sidebar'],              is_active: true },
