...
const FEATURES: FeatureRow[] = [
  ...
  { key: 'admin-attendance',            label: 'Advanced Attendance',      description: 'Institute-wide attendance overview and analytics',    scope: 'INSTITUTE', category: 'ATTENDANCE',     pricing: 'PAID',  billing_cycle: 'MONTHLY', is_core: false, dependencies: ['daily-attendance'],      ui_targets: ['sidebar', 'dashboard'], is_active: true },
  { key: 'lecture-live-attendance',     label: 'Lecture Live Attendance',  description: 'Real-time attendance for live lectures',              scope: 'INSTITUTE', category: 'ATTENDANCE',     pricing: 'PAID',  billing_cycle: 'MONTHLY', is_core: false, dependencies: ['institute-lectures'],    ui_targets: ['sidebar'],              is_active: true },
  { key: 'lecture-recording-attendance',label: 'Recording Attendance',     description: 'Track attendance for recorded lecture views',         scope: 'INSTITUTE', category: 'ATTENDANCE',     pricing: 'PAID',  billing_cycle: 'MONTHLY', is_core: false, dependencies: ['institute-lectures'],    ui_targets: ['sidebar'],              is_active: true },
  ...
  { key: 'class-live-attendance',       label: 'Live Lecture Attendance',   description: 'Real-time attendance tracking for class lectures',     scope: 'CLASS',    category: 'ATTENDANCE',     pricing: 'PAID',  billing_cycle: 'MONTHLY', is_core: false, dependencies: ['class-lectures'], ui_targets: ['sidebar'],             is_active: true },
  { key: 'class-recording-attendance',  label: 'Recording Attendance',      description: 'Track views for recorded class lecture videos',        scope: 'CLASS',    category: 'ATTENDANCE',     pricing: 'PAID',  billing_cycle: 'MONTHLY', is_core: false, dependencies: ['class-lectures'], ui_targets: ['sidebar'],             is_active: true },
  ...
  { key: 'subject-live-attendance',     label: 'Live Lecture Attendance',   description: 'Real-time attendance for subject lectures',            scope: 'SUBJECT',  category: 'ATTENDANCE',     pricing: 'PAID',  billing_cycle: 'MONTHLY', is_core: false, dependencies: ['lectures'],    ui_targets: ['sidebar'],              is_active: true },
  { key: 'subject-recording-attendance',label: 'Recording Attendance',      description: 'Track views of recorded subject lecture videos',       scope: 'SUBJECT',  category: 'ATTENDANCE',     pricing: 'PAID',  billing_cycle: 'MONTHLY', is_core: false, dependencies: ['lectures'],    ui_targets: ['sidebar'],              is_active: true },
